...
public class SwerveModuleState2 extends SwerveModuleState
{
   ...
   */
  public SwerveModuleState2(
      double distanceMeters, double speedMetersPerSecond, double accelMetersPerSecondSq, Rotation2d angle,
  ...
  public String toString()
  {
    return String.format(
        "SwerveModuleState(Position: %.2f m, Speed: %.2f m/s, Accel: %.2f m/s/s, Angle: %s, Omega: %.2f rad/s)",
        distanceMeters,
        speedMetersPerSecond,
        accelMetersPerSecondSq,
        angle,
        omegaRadPerSecond);
  }
}

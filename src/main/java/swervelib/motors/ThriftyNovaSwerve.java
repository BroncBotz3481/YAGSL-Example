...
public class ThriftyNovaSwerve extends SwerveMotor {
     ...
     */
    public ThriftyNovaSwerve(ThriftyNova motor, boolean isDriveMotor) {
        this.motor = motor;
    ...
    /**
     * Initialize the {@link SwerveMotor} as a {@link ThriftyNova} connected to a
     * Brushless Motor.
     *
     * @param id           CAN ID of the SparkMax.
     * @param isDriveMotor Is the motor being initialized a drive motor?
     */
    public ThriftyNovaSwerve(int id, boolean isDriveMotor) {
